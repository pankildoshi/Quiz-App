...
const start_java = document.querySelector(".start-btn-java");
const start_python = document.querySelector(".start-btn-python");
const start_css = document.querySelector(".start-btn-css");
const start_js = document.querySelector(".start-btn-js");
const start_html5 = document.querySelector(".start-btn-html5");
const start_nodejs = document.querySelector(".start-btn-nodejs");
...
function fetchData() {
    fetch('data.json').then(
        ...
        data => {
            let pos = langs.indexOf(language);
            questions = data.languages[pos].questions;
